...
import "./styles/whatCanYouSection.css";
...
provide the tools and support needed to design engaging and informative content.
...
You can pick courses that match your interests and learning goals
              </h4>
            </div>
          </div>
          <div className="totalcontentcard">
